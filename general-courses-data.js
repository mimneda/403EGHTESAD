window.GENERAL_CLUSTERS_CONFIG = [
  ...
  },
  {
    ...
    courses: [
      ...
      { id: 'andisheh_siasi', name: 'اندیشه سیاسی امام خمینی', aliases: ['اندیشه سیاسی امام خمینی (ره)', 'انديشه سياسي امام خميني (ره)'], units: 2, disabledInChart: true, disabledNote: 'فعلاً ارائه نمی‌شود' }
    ]
  },
  {
    id: 'tarikh',
